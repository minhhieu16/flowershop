            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='thankyou.php'">Thanh toán COD</button>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              <img src="../Data/images/hero_1.jpg" alt="Image placeholder" class="img-fluid rounded mb-4">
